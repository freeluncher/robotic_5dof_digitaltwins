...
- [ ] Definisikan format `RawHardwareData` untuk input hardware.
...
- [ ] Tambahkan test helper dan fixture data untuk state dan kinematics.
...
- [ ] Import GLB model ke pipeline frontend.
...
- [ ] Buat SignalR hub untuk telemetry robot.
- [ ] Definisikan event untuk joint angle update.
...
- [ ] Definisikan format input dari hardware ESP32.
